...
folium.Marker(오사카,
              ...
              icon=folium.CustomIcon(일본icon, icon_size=(30, 30))).add_to(m)
folium.Marker(도쿄,
              popup=link_world+"223224729372'>2023.09.15 일본 도쿄 1" + link_1 + "223224964518'>2023.09.16 일본 도쿄 2" + link_1 + "223225248938'>2023.09.17 일본 도쿄 3" + link_1 + "223225949011'>2023.09.18 일본 도쿄 4" + link_1 + "223226573350'>2023.09.19 일본 도쿄 5" + link_1 + "223226729220'>2023.09.20 일본 도쿄 6" + link_1 + "223579746932'>2024.08.21 일본 가마쿠라, 도쿄" + link_1 + "223581330083'>2024.08.22 일본 도쿄</a>" ,
              tooltip='도쿄',
              icon=folium.CustomIcon(일본icon, icon_size=(30, 30))).add_to(m)
folium.Marker(치바,
              popup=link_world+"223576093851'>2024.08.18 일본 치바 1" + link_1 + "223577033127'>2024.08.19 일본 치바 2"  + link_1 + "223578546520'>2024.08.20 일본 치바 3"  + link_1 + "223582723660'>2024.08.23~24 일본 치바 4</a>" ,
              tooltip='치바',
              icon=folium.CustomIcon(일본icon, icon_size=(30, 30))).add_to(m)
